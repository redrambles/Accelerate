...
function accelerate_child_scripts() {
  ...
  wp_enqueue_script('modernizr-geolocation', get_stylesheet_directory_uri() . '/js/modernizr.js', array('jquery'), '20160825', false );
    wp_enqueue_script('geo', get_stylesheet_directory_uri() . '/js/geo.js', array('jquery'), '20160825', false );
